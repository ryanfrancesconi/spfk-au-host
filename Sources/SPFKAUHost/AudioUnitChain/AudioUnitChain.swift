...
extension AudioUnitChain {
    public var effectsDescription: String {
        get async {
            ...
            var value = "\(effects.count)/\(count) Audio Unit\(effects.pluralString)"
    ...
    public var connectionDescription: String {
        get async {
            ...
            let inputDesc = input.ioConnectionDescription
            let outputDesc = output.ioConnectionDescription
            let effectsDesc = await effectsDescription
